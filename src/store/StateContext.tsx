...
type StateContextType = {
    ...
    setSelectedVideoCtx: React.Dispatch<React.SetStateAction<YoutubeVideoItemsType|null>>
}
...
function StateContextProvider({children}:{children:ReactNode}) {
    ...
    const [selectedVideoCtx,setSelectedVideoCtx] = useState<YoutubeVideoItemsType|null>(null)

    const state:StateContextType = {
        searchKeyCtx, setSearchKeyCtx ,
        selectedVideoCtx , setSelectedVideoCtx
    }
